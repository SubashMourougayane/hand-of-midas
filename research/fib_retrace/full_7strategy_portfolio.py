"""7-strategy portfolio incl Fib V2 TOP1."""
...
PATHS = {
    ...
    "Fib_V2_long_H1": Path("/Users/subash/SUBASH/GoldDigger/research/fib_retrace/fib_v2_long_lb5_hold72h_all_ext1.618_sl0.02_trades.parquet"),
}
...
def main():
    ...
    for k, p in PATHS.items():
        ...
        series[k] = s
        print(f"{k:25s} n={len(df):5d}  months={len(s):3d}  total=${s.sum():+12,.2f}  avg=${s.mean():+9,.2f}/mo")
    ...
    print(f"\n[Per-year $ across all 7 accounts]")
    ...
    out_path = Path("/Users/subash/SUBASH/GoldDigger/research/fib_retrace/7_strategy_portfolio_monthly.csv")
