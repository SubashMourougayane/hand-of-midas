...
class FibV2IntradayAPlusD:
    ...
    def __init__(
        ...
        **_runner_kwargs,
        ...
        self.symbol = symbol
        self.a = FibV2IntradayA(symbol=symbol, strict_after=strict_after, qty=qty, cost_usd=cost_usd)
        self.d = FibV2IntradayD(symbol=symbol, strict_after=strict_after, qty=qty, cost_usd=cost_usd)
