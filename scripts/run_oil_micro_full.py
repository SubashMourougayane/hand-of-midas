"""Full-history Oil Micro BT on JM data (bias_mode=neutral).
...
print("Running Oil Micro full-history BT (bias_mode=neutral, JM data ~2019-05-22 → 2026-06-18)...")
t0 = time.time()
...
print()
print("=" * 60)
print("Oil Micro — Full History (JM, bias_mode=neutral)")
print("=" * 60)
