"""Full-history Gold Micro BT on JM data, single-strategy (matches live).

Live Gold Micro runs ONLY micro_alpha_sweep — no mean_rev, no cross_market.
Default BT runs all 3 → inflated. We pass strategies=['micro_alpha_sweep']
explicitly to make BT comparable to live.

JM data starts 2019-06-03 → 2026-06-18 (~7 years).
"""
...
print("Running Gold Micro full-history BT (single-strategy=micro_alpha_sweep, bias_mode=neutral)...")
t0 = time.time()
...
print()
print("=" * 60)
print("Gold Micro — Full History (JM, single-strategy, neutral bias)")
print("=" * 60)
