...
# Final status
printf "\n"
printf "  ${GREEN}✅ ALL SYSTEMS ONLINE${NC}\n\n"
printf "  ${YELLOW}🥇 Gold${NC}  http://localhost:5053  ${DIM}(XAU/USD)${NC}\n"
printf "  ${CYAN}🛢️  Oil${NC}   http://localhost:5054  ${DIM}(BCO/USD)${NC}\n"
printf "  ${PURPLE}🖥️  UI${NC}    http://localhost:3001  ${DIM}(Dashboard)${NC}\n"
printf "\n"
printf "  ${BOLD}📅 Trading Schedule (UTC):${NC}\n"
printf "  ${DIM}├─${NC} ${YELLOW}22:00${NC}       Cross-Market + Mean-Rev ${DIM}(daily)${NC}\n"
printf "  ${DIM}├─${NC} ${CYAN}08:00-10:30${NC} Alpha-Sweep Gold ${DIM}(London, 3min)${NC}\n"
