...
def run_backtest(
    ...
    require_prev_reversal: Filter #14 — require engulfing prev to be reversal-direction.
      None = config default (False = legacy).
    """
    ...
    if require_prev_reversal is None:
        require_prev_reversal = ALPHA_SWEEP.get("require_prev_reversal", False)
